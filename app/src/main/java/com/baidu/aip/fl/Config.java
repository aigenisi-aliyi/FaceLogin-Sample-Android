...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "GhAEzAQnkMFD5p6QVdwDPfg3";
    public static String secretKey = "6SgCIUjPLYEGfuOSm8Nxcubn9Z8CIQIl";
    public static String licenseID = "FaceMonitor-face-android";
     ...
     */
    public static String groupID = "FaceMinotor";
